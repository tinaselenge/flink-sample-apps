...
public class Sales extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8368911982385048531L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Sales\",\"namespace\":\"kafka.schema\",\"fields\":[{\"name\":\"user_id\",\"type\":\"string\"},{\"name\":\"product_id\",\"type\":\"string\"},{\"name\":\"invoice_id\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"string\"},{\"name\":\"unit_cost\",\"type\":\"string\"}]}");
   ...
   */
  public static kafka.schema.Sales.Builder newBuilder() {
    return new kafka.schema.Sales.Builder();
  }
   ...
   * @return A new Sales RecordBuilder
   */
  public static kafka.schema.Sales.Builder newBuilder(kafka.schema.Sales.Builder other) {
    return new kafka.schema.Sales.Builder(other);
  }
   ...
   * @return A new Sales RecordBuilder
   */
  public static kafka.schema.Sales.Builder newBuilder(kafka.schema.Sales other) {
    return new kafka.schema.Sales.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Sales>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(kafka.schema.Sales.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(kafka.schema.Sales other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.user_id)) {
        this.user_id = data().deepCopy(fields()[0].schema(), other.user_id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.schema.Sales.Builder setUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.schema.Sales.Builder clearUserId() {
      user_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.schema.Sales.Builder setProductId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.schema.Sales.Builder clearProductId() {
      product_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.schema.Sales.Builder setInvoiceId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.schema.Sales.Builder clearInvoiceId() {
      invoice_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.schema.Sales.Builder setQuantity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.schema.Sales.Builder clearQuantity() {
      quantity = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.schema.Sales.Builder setUnitCost(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.schema.Sales.Builder clearUnitCost() {
      unit_cost = null;

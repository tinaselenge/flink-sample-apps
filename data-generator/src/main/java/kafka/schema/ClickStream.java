...
public class ClickStream extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2902792335611605907L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ClickStream\",\"namespace\":\"kafka.schema\",\"fields\":[{\"name\":\"user_id\",\"type\":\"string\"},{\"name\":\"product_id\",\"type\":\"string\"}]}");
   ...
   */
  public static kafka.schema.ClickStream.Builder newBuilder() {
    return new kafka.schema.ClickStream.Builder();
  }
   ...
   * @return A new ClickStream RecordBuilder
   */
  public static kafka.schema.ClickStream.Builder newBuilder(kafka.schema.ClickStream.Builder other) {
    return new kafka.schema.ClickStream.Builder(other);
  }
   ...
   * @return A new ClickStream RecordBuilder
   */
  public static kafka.schema.ClickStream.Builder newBuilder(kafka.schema.ClickStream other) {
    return new kafka.schema.ClickStream.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ClickStream>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(kafka.schema.ClickStream.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(kafka.schema.ClickStream other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.user_id)) {
        this.user_id = data().deepCopy(fields()[0].schema(), other.user_id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.schema.ClickStream.Builder setUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.schema.ClickStream.Builder clearUserId() {
      user_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.schema.ClickStream.Builder setProductId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.schema.ClickStream.Builder clearProductId() {
      product_id = null;
